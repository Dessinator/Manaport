...
var _status_effect_visuals: Dictionary = {}
...
func _on_status_effect_applied(status_effect_instance: Dictionary):
	...
	_status_effect_visuals[status_effect_instance["metadata"]["name"]] = instance
	#_status_effect_visuals.append(instance)
	instance.set_status_effect(status_effect_instance)
func _status_effect_stack_applied(status_effect_instance: Dictionary):
	var visual = _status_effect_visuals[status_effect_instance["metadata"]["name"]]
	
	visual.set_stacks_label(status_effect_instance["stacks"].size())
	visual.set_duration_label(StatusEffect.get_turns_left_for_status_effect_instance(status_effect_instance))
func _status_effect_ticked(status_effect_instance: Dictionary):
	var visual = _status_effect_visuals[status_effect_instance["metadata"]["name"]]
	
	visual.set_stacks_label(status_effect_instance["stacks"].size())
	visual.set_duration_label(StatusEffect.get_turns_left_for_status_effect_instance(status_effect_instance))
func _status_effect_stack_removed(status_effect_instance: Dictionary):
	var visual = _status_effect_visuals[status_effect_instance["metadata"]["name"]]
	
	visual.set_stacks_label(status_effect_instance["stacks"].size())
	visual.set_duration_label(StatusEffect.get_turns_left_for_status_effect_instance(status_effect_instance))
func _on_status_effect_removed(status_effect_instance: Dictionary):
	var visual = _status_effect_visuals[status_effect_instance["metadata"]["name"]]
	
	#var visual = _status_effect_visuals.filter(func(vis): return vis.get_attached_status_effect_instance() == status_effect_instance)[0]
