...
const ACTOR_INFO_SCENE = preload("res://nodes/stage/actor_info.tscn")
const MINI_ACTOR_INFO_SCENE = preload("res://nodes/stage/mini_actor_info.tscn")
const ACTION_ORDER_VISUAL_SCENE = preload("res://nodes/stage/action_order_visual.tscn")
