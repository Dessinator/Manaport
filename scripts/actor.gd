...
func print_stats():
	...
	print("VTLY (Soundness): {value}".format({"value": _stats.get_vtly(false, false)}))
	print("VTLY (Soundness)/MXHL (Max Health): {value}".format({"value": _stats.get_substat_curves().sample_mxhl_curve(_stats.get_vtly(false, true), false, false)}))
	print("VTLY (Soundness)/MXST (Max Stamina): {value}".format({"value": _stats.get_substat_curves().sample_mxst_curve(_stats.get_vtly(false, true), false, false)}))
	print("VTLY (Soundness)/AGLT (Agility): {value}".format({"value": _stats.get_substat_curves().sample_aglt_curve(_stats.get_vtly(false, true), false, false)}))
